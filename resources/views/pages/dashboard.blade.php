                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Institutions</p>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Loan Products</p>
                                    <h5 class="font-weight-bolder">
                                        {{ $loanproducts }}
                                    </h5>
                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center mb-3">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">Recent Expenses</h6>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center justify-content-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <h6 class="mb-0 text-sm"> &nbsp; &nbsp; &nbsp;{{ $expense->voucher_no }}
                                            </h6>
                                        </td>
                                        <td>
                                            <p class="text-sm font-weight-normal mb-0">{{ $expense->amount }}
                                        <td>
                                            <span
                                                class="text-sm font-weight-normal">{{ $expense->transaction_date }}</span>
                                        </td>
                                    </tr>
                                    <?php endforeach ; ?>
                                </tbody>
